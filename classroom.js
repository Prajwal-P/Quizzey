let classroom =
	{
		...
		quizzes: [
			...
			},
			{
				...
				end_time: new Date('2020', '11', '15', '10', '55', '10'),
				// score: 85
			},
			{
				id: 4,
...
function quiz_card_template(cl) {
	...
	if(classroom.class_code) {
		...
		id2 = "Open Quiz"
		id3 = "Start Time: " + cl.start_time.getDate() +" "+ month[cl.start_time.getMonth()] +" "+ cl.start_time.getFullYear() +" "+ cl.start_time.toLocaleTimeString().replace(/([\d]+:[\d]{2})(:[\d]{2})(.*)/, "$1$3")
		id4 = "End Time: " + cl.end_time.getDate() +" "+ month[cl.end_time.getMonth()] +" "+ cl.end_time.getFullYear() +" "+ cl.end_time.toLocaleTimeString().replace(/([\d]+:[\d]{2})(:[\d]{2})(.*)/, "$1$3")
	} else {
